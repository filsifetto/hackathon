...
This folder contains project-wide documentation. Use this index to find what you need quickly.
...
- **First-time setup (API keys):** [API_SETUP.md](API_SETUP.md)
...
- Keep one topic per file; use a clear filename (e.g. `DEPLOYMENT.md`, `TESTING.md`).
- Add the new file to the table above and to the “Quick links” section if it’s a common task.
- Write in plain language: assume a new contributor can follow the steps without prior context.
