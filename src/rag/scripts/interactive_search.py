...
class InteractiveSearchInterface:
    ...
    def display_welcome(self):
        ...
        self.console.print(Panel.fit(
            "[bold blue]filsifettos rag Interactive Search[/bold blue]\n"
...
[bold]Explanation:[/bold] {result.explanation}"""
    ...
    def show_help(self) -> None:
        ...
        help_content = """
[bold blue]filsifettos rag Interactive Search Help[/bold blue]
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="filsifettos rag Interactive Search"
    )
    parser.add_argument(
        "--language", "-l",
        choices=["en", "no"],
